...
import { Globe, Mail, Lock, User, Eye, EyeOff, Briefcase, CheckCircle, AlertCircle } from "lucide-react"
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage("Your account has been created! Please check your email to confirm your registration.")

      // If auto-confirmation is enabled (development), redirect to dashboard
      if (data?.session) {
      ...
      <main className="flex flex-1 items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-[600px]">
          <div className="space-y-2 text-center">
            ...
            <p className="text-muted-foreground">Join thousands of job seekers and employers on our global platform</p>
          </div>
              ...
              <TabsContent value="employer" className="mt-6 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="rounded-lg border p-4">
                    <h3 className="font-medium">Why join as an employer?</h3>
                    <ul className="mt-2 space-y-2">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="mt-0.5 h-4 w-4 text-primary shrink-0" />
                        <span className="text-sm">Access to global talent pool</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="mt-0.5 h-4 w-4 text-primary shrink-0" />
